...
values (2, 2000, true, 1), ( null , 3000, false , null),
       (1, 2000, true, 3), ( null, 2000, true, 2);
...
insert into waypoints(city_code, type, order_id)
values (1, 'LOADING', 1), (3, 'LOADING', 1),(2, 'UNLOADING', 1),
       (3, 'LOADING', 2),(2, 'UNLOADING', 2),(1, 'UNLOADING', 2);
